  ...
  <div className='text-4xl mb-10   text-center text-red-900 font-serif font-bold hover:text-red-700'>
    ...
    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      ...
      <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <p className="text-base leading-relaxed mt-2">
        "I've created a Facebook clone page as part of my practice project, replicating core social features like user profiles, friend connections, and content sharing to enhance my web development skills."
        </p>
