...
const Contact = () => {
  return (
    <div id='contact'>
        <h1 className='text-3xl font-serif font-semibold text-center text-red-900 mb-2'>Contact us</h1>
      <section className="text-gray-600 body-font relative ">
  <div className="absolute inset-0 bg-gray-100 px-4 py-5">
    <iframe 
      width="100%"
      height="100%"
      title="map"
  ...
  <div className="container px-2 py-24 mx-auto flex">
    <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
      ...
      <p className="leading-relaxed mb-5 text-gray-600">
          If you have any query Kindly contact us      </p>
